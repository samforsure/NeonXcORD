...
public final class PreferenceKeys {
    ...
    // NeonX Cord — Custom RPC
    public static final String NEONX_RPC_ENABLED  = "neonx.rpc.enabled";
    public static final String NEONX_RPC_ALWAYS   = "neonx.rpc.always";   // show RPC even without token login

    // NeonX Cord — Server Onboarding Auto-Select
    public static final String NEONX_AUTO_ONBOARDING = "neonx.auto.onboarding";

    // NeonX Cord — Token Extractor helper
    public static final String NEONX_TOKEN_EXTRACTOR_SHOWN = "neonx.token.extractor.shown";
